...
BEGIN DRIVER
 ...
 PARAMETER clock-names =  clk s00_axi_aclk
 PARAMETER clocks = zynqmp_clk 71>, <&zynqmp_clk 71
 PARAMETER compatible = xlnx,audio-pipeline-1.0
...
BEGIN DRIVER
 ...
 PARAMETER clock-names =  s_axi_lite_aclk m_axi_s2mm_aclk
 PARAMETER clocks = zynqmp_clk 71>, <&zynqmp_clk 71
 PARAMETER compatible = xlnx,axi-dma-7.1 xlnx,axi-dma-1.00.a
 PARAMETER reg = 0x0 0xa0000000 0x0 0x10000
